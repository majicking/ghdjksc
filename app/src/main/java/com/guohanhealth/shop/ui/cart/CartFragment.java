...
public class CartFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //下拉刷新监听
        mPullRefreshScrollView.setOnRefreshListener(refreshView -> loadCartData());
        goShoppingID = (Button) layout.findViewById(R.id.goShoppingID);
        goShoppingID.setOnClickListener(view -> {
    ...
    private void loadCartData() {
        //检查是否已经登录
        loginKey = myApplication.getLoginKey();
        ...
        RemoteDataHandler.asyncLoginPostDataString(url, params, myApplication, data -> {
            ...
            if (data.getCode() == HttpStatus.SC_OK) {
                try {
                    ...
                    tvSum.setText(getString(R.string.text_rmb) + obj.getString("sum"));
                } catch (Exception e) {
                    e.printStackTrace();
                }
            } else {
    ...
    private View getCartListItemView(JSONObject cartItemObj) {
        ...
        if (voucherString.equals("")) {
            ...
            llVoucher.setOnClickListener(view -> ncStoreVoucherPopupWindow.showPopupWindow());
        }
        //免运费规则
            ...
            for (int i = 0; i < size; i++) {
                ...
                btnSelect.setOnClickListener(view -> {
                    ...
                    for (String cartId1 : storeCardId) {
                        CartGoodsItem item1 = cartGoods.get(cartId1);
                ...
                ivGoodsImage.setOnClickListener(view -> ShopHelper.showGoods(getActivity(), goodsId));
                TextView tvGoodsName = (TextView) goodsView.findViewById(R.id.tvGoodsName);
                tvGoodsName.setOnClickListener(view -> ShopHelper.showGoods(getActivity(), goodsId));
                ...
                tvGoodsPrice.setText(context.getResources().getString(R.string.text_rmb) + goodsPrice);
                if ((size - 1) <= i) {
                    tvLine.setVisibility(View.GONE);
                }
                //删除
                ImageButton btnDel = (ImageButton) goodsView.findViewById(R.id.btnDel);
                btnDel.setOnClickListener(view -> delCartGoods(cartId));
                //数量
                ...
                btnMinus.setOnClickListener(view -> changeCartGoodsQuantity(cartId, tvGoodsNum, "minus"));
                btnAdd.setOnClickListener(view -> changeCartGoodsQuantity(cartId, tvGoodsNum, "add"));
        ...
        btnSelectStore.setSelected(true);
        btnSelectStore.setOnClickListener(view -> {
    ...
    private void delCartGoods(final String cartId) {
        ...
        delNCDialog.setOnDialogConfirm(() -> {
    ...
    private void setCartTotal() {
        ...
        tvSum.setText(context.getResources().getString(R.string.text_rmb) + ShopHelper.getPriceString(total));
    }
