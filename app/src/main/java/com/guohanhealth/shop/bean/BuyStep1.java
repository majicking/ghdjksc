...
public class BuyStep1 {
    ...
    public String getPredeposit_allow() {
        return predeposit_allow;
    }

    public void setPredeposit_allow(String predeposit_allow) {
        this.predeposit_allow = predeposit_allow;
    }

    public String getRc_balance_allow() {
        return rc_balance_allow;
    }
    ...
    public String toString() {
        return "BuyStep1{" +
                ...
                ", rpt_list='" + rpt_list + '\'' +
                ", healthbean_allow='" + healthbean_allow + '\'' +
                ", predeposit_allow='" + predeposit_allow + '\'' +
                ", rc_balance_allow='" + rc_balance_allow + '\'' +
                '}';
    }
}
