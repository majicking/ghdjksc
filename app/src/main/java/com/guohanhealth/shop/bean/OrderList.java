...
public class OrderList {
    public static class Attr {
        ...
        public static final String IF_AGAIN = "if_again";
    }
    ...
    public OrderList(String order_id, String order_sn, String order_state,
                     ...
                     String if_lock, String if_deliver, String zengpin_list,
                     String if_evaluation, String if_evaluation_again,
                     String if_refund_cancel, String refund_list, String refund_state,String if_again) {
        super();
    ...
    public static ArrayList<OrderList> newInstanceList(String jsonDatas) {
        ...
        try {
            ...
            for (int i = 0; i < size; i++) {
                ...
                String if_again = obj.optString(Attr.IF_AGAIN);
                AdvertDatas.add(new OrderList(order_id, order_sn, order_state, store_name, state_desc, order_amount, extend_order_goods,
                        payment_name, shipping_fee, if_cancel, if_receive, if_lock, if_deliver, zengpin_list,
                        if_evaluation, if_evaluation_again, if_refund_cancel, refund_list, refund_state,if_again
                ));
            }
