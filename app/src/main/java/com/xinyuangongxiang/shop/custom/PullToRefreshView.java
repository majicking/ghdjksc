...
public class PullToRefreshView extends LinearLayout {
	...
	private void headerPrepareToRefresh(int deltaY) {
		...
		if (newTopMargin >= 0 && mHeaderState != RELEASE_TO_REFRESH) {
			mHeaderTextView.setText(getContext().getResources().getString(R.string.pull_to_refresh_release_label));
			...
			mHeaderImageView.startAnimation(mFlipAnimation);
			// mHeaderImageView.
			mHeaderTextView.setText(getContext().getResources().getString(R.string.pull_to_refresh_pull_label));
	...
	public void headerRefreshing() {
		...
		mHeaderTextView.setText(getContext().getResources().getString(R.string.pull_to_refresh_refreshing_label));
