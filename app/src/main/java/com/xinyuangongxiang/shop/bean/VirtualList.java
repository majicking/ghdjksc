...
public class VirtualList {
		...
		public VirtualList(String vr_indate, String gc_id, String code_list,
				...
				String buyer_msg, String order_state_text,String goods_image_url,String if_again) {
			super();
			...
			try {
				...
				for(int i = 0; i < size; i++){
					...
					AdvertDatas.add(new VirtualList(vr_indate, gc_id, code_list, commis_rate, refund_state, order_state,
							...
							goods_id, order_sn, if_pay, add_time, finnshed_time, delete_state, buyer_msg, order_state_text,goods_image_url,if_again));
				}
