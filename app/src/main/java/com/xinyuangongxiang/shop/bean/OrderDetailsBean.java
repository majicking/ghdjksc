...
public class OrderDetailsBean {
    ...
    private String if_again;

    public OrderDetailsBean() {
    }

    public OrderDetailsBean(String order_id, String order_sn, String store_id, String store_name,
                            String add_time, String payment_time, String shipping_time,
                            String finnshed_time, String order_amount, String shipping_fee,
                            String real_pay_amount, String state_desc,
                            String payment_name, String order_message,
                            String reciver_phone, String reciver_name,
                            String reciver_addr, String store_member_id,
                            String store_phone, String order_tips, String promotion,
                            String invoice, String if_deliver, String if_buyer_cancel,
                            String if_refund_cancel, String if_receive, String if_evaluation,
                            String if_lock, String goods_list,
                            String zengpin_list, String ownshop,String if_again) {
        ...
        this.if_again = if_again;
    }

    public String getIf_again() {
        return if_again;
    }

    public void setIf_again(String if_again) {
        this.if_again = if_again;
    }
