...
public class XRefreshViewFooter extends LinearLayout implements IFooterCallBack {
    ...
    public void callWhenNotAutoLoadMore(final XRefreshView.XRefreshViewListener listener) {
        mClickView.setText(getContext().getResources().getString(R.string.xrefreshview_footer_hint_click));
    ...
    public void onStateFinish() {
        mHintView.setText(getContext().getResources().getString(R.string.xrefreshview_footer_hint_normal));
