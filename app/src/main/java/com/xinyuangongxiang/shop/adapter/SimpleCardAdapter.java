...
import com.xinyuangongxiang.shop.bean.FocusListBean;
import com.xinyuangongxiang.shop.bean.NewsListBean;
...
import com.xinyuangongxiang.shop.bean.item.VisibilityItem;
import com.xinyuangongxiang.shop.custom.GlideCircleTransform;
import com.xinyuangongxiang.shop.custom.MyDecoration;
import com.xinyuangongxiang.shop.lib.tab.NetworkImageHolderView;
import com.xinyuangongxiang.shop.ui.fenxiao.DianboAudeoInfoActivity;
import com.xinyuangongxiang.shop.lib.video.JCVideoPlayer;
import com.xinyuangongxiang.shop.lib.video.JCVideoPlayerStandard;
import com.xinyuangongxiang.shop.lib.video.videoimg.VideoFrameImageLoader;
import com.xinyuangongxiang.shop.ui.fenxiao.WebActivity;
import com.xinyuangongxiang.shop.ui.fenxiao.ZhiBoActivity;
import com.xinyuangongxiang.shop.ui.fenxiao.ZhixunContentActivity;
...
//        else {
//            XListViewFooter mFooterView = new XListViewFooter(mContext);
//            view = mFooterView;
...
//        }
        ...
        dingboWenziAdapter.setOnItemClickListener(new com.xinyuangongxiang.shop.lib.tab.OnItemClickListener() {
            @Override
...
//        LoadImage.loadImg(mContext,holder.dian_logo,bean.getStore_logo());
        Glide.with(mContext).load(bean.getStore_logo()).transform(new GlideCircleTransform(mContext)).into(holder.dian_logo);
...
//            holder.textView3.setText(bean.getPromote_text());
...
//            }
//            jcVideoPlayerStandard.getForeground().setAlpha((int)0.3);
            ...
            if (setUp) {
                try {
                    ...
                    holder.jcVideoPlayerStandard.app_video_status_text.getBackground().setAlpha(60);//0--255为透明度值
...
//        if(mHeaderView != null && viewType == TYPE_HEADER) return new ZiXunViewHolder(mHeaderView);
//
//
//        RecyclerView.ViewHolder viewHolder = null;
//        View itemView = null;
//
//        View layout = LayoutInflater.from(parent.getContext()).inflate(R.layout.fragment_fenxiao_listview_item_zixun, parent, false);
//        return new ZiXunViewHolder(layout);
//    }
//
//    @Override
...
//
//        ZiXunViewHolder mViewHolder = (ZiXunViewHolder) holder;
//
//        final int pos = getRealPosition(mViewHolder);
//        mViewHolder.news_name.setText(mList.get(pos).getNews_name());
//        mViewHolder.news_name1.setText(mList.get(pos).getNews_name());
//        mViewHolder.pageview.setText(mList.get(pos).getPage_view() + "人观看");
//        mViewHolder.add_time.setText(mList.get(pos).getAdd_time());
//        LoadImage.loadImg(mContext,mViewHolder.news_pic,mList.get(pos).getNews_pic());
//        if(onItemClickListener != null){
//            mViewHolder.news_pic.setOnClickListener(new View.OnClickListener() {
//                @Override
//                public void onClick(View v) {
