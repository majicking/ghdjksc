...
import com.xinyuangongxiang.shop.BuildConfig;
...
//    public static final String APP_ID = "wx76c019464a5ebdaa";
     ...
     * 收货地址为空
     */
    public static final int SELECT_ADDRESS_NULL = 7;
...
//	public static final String HOST = "b2b2c.shopnctest.com/test1";
     ...
     */
    /*订单列表 再次确认信息*/
    public static final String SUREORDERAGAIN = URL_CONTEXTPATH + "act=member_order&op=sureOrderAgain";
    /*虚拟订单列表 再次确认信息*/
    public static final String ORDERSUREAGAIN = URL_CONTEXTPATH + "act=member_order&op=orderSureAgain";
    /*预存款充值*/
    public static final String RECHARGE = URL_CONTEXTPATH + "act=recharge";
    /*预存款提现*/
    public static final String PUTFORWARD = URL_CONTEXTPATH + "act=recharge&op=pd_cash_add";

    //跳转订单页面标识 全部0", "待付款1", "待收货2", "待自提3", "待评价4    "全部0", "待付款1", "待使用2"
    public static final String ORDERNUMBER = "ordernumber";
    //虚拟true/实物false订单列表
    public static final String ORDERTYPE = "ordertype";

    //单支付成功返回标识
    public static final String REFRESHLAYOUT = "10";
    //刷新余额
    public static final String PREDBROADCAST = "1000";
    //充值 支付宝
    public static final String ALIPAY_MEMBERPAYMENTRECHARGE = URL_CONTEXTPATH + "act=member_payment_recharge&op=alipay_native_pay&payment_code=alipay_native&pay_sn=";
    //充值 微信
    public static final String WEIXINPAY_PREDBROADCAST = URL_CONTEXTPATH + "act=member_payment_recharge&op=wx_app_pay3&payment_code=wxpay&pay_sn=";
    // 健康豆列表
