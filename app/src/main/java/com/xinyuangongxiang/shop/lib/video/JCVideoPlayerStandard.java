package com.xinyuangongxiang.shop.lib.video;
...
public class JCVideoPlayerStandard extends JCVideoPlayer {
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.thumb) {
            if (TextUtils.isEmpty(url)) {
                Toast.makeText(getContext(), getContext().getResources().getString(R.string.no_url), Toast.LENGTH_SHORT).show();
                return;
            }
    ...
    public void showWifiDialog() {
        ...
        builder.setMessage(getContext().getResources().getString(R.string.tips_not_wifi));
        builder.setPositiveButton(getContext().getResources().getString(R.string.tips_not_wifi_confirm), new DialogInterface.OnClickListener() {
            @Override
        ...
        builder.setNegativeButton(getContext().getResources().getString(R.string.tips_not_wifi_cancel), new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                dialog.dismiss();
            }
    ...
    public void updateStartImage() {
        if (currentState == CURRENT_STATE_PLAYING) {
            ...
            startButton1.setImageResource(R.drawable.dianbo_play);
        }
    }
