...
import com.xinyuangongxiang.shop.bean.OrderDetailsBean;
import com.xinyuangongxiang.shop.bean.OrderGoods;
import com.xinyuangongxiang.shop.bean.ZenPinBean;
...
public class OrderDetailsActivity extends BaseActivity {
    ...
    private Button textOrderOperation1;//再次确认
...
//        loadOrderDetails();
    ...
    private void initView() {
        ...
        textOrderOperation1 = (Button) findViewById(R.id.textOrderOperation1);
    ...
    private void loadOrderDetails() {
        ...
        showProgressDialog(mActivity,"正在加载...");
        RemoteDataHandler.asyncDataStringGet(url, new RemoteDataHandler.Callback() {
            ...
            public void dataLoaded(ResponseData data) {
                ...
                if (data.getCode() == HttpStatus.SC_OK) {
                    try {
                        ...
                        if (orderDetails.getIf_again().equals("true")) {
                        ...
                        textOrderOperation1.setOnClickListener(v -> {
                            ...
                            builder.setTitle("操作提示")
                                    ...
                                    .setPositiveButton("确认",
                                            (dialog, whichButton) ->
                                                    okAgainOrder(orderDetails)).create().show();
            ...
            private void okAgainOrder(OrderDetailsBean orderDetails) {
                HashMap<String, String> params = new HashMap<String, String>();
                params.put("key", myApplication.getLoginKey());
                params.put("order_id", orderDetails.getOrder_id());
...
//                                                        sendBroadcast(mIntent);
                                            ...
                                            textOrderOperation1.setVisibility(View.GONE);
                                            Intent mIntent = new Intent(
                                ...
                                Toast.makeText(OrderDetailsActivity.this, "请求失败", Toast.LENGTH_SHORT).show();
                            }
                        } else if (msg.what == 2) {
                            Toast.makeText(OrderDetailsActivity.this, "请求失败", Toast.LENGTH_SHORT).show();
                ...
                new Thread(() -> {
                    ...
                    try {
                        String json1 = HttpHelper.post(Constants.SUREORDERAGAIN, params);
                        message.obj = json1;
                        message.what = 1;
                    } catch (Exception e) {
                        message.what = 2;
