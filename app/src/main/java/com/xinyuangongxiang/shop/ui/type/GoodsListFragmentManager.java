...
import com.xinyuangongxiang.shop.adapter.AreaSpinnerAdapter;
import com.xinyuangongxiang.shop.adapter.ContractGridViewAdapter;
import com.xinyuangongxiang.shop.bean.CityList;
import com.xinyuangongxiang.shop.bean.ContractInfo;
...
public class GoodsListFragmentManager extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (searchHotName != null && !searchHotName.equals("")) {
            ...
            tvSearch.setHint(getResources().getString(R.string.default_search_text));
        }
