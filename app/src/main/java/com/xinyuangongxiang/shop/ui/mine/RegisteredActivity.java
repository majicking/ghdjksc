...
import com.xinyuangongxiang.shop.bean.Login;
...
public class RegisteredActivity extends BaseActivity {
    ...
    private EditText editUserName, editPassword, editPasswordConfirm, editEmail, editCode;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String rcode = getIntent().getStringExtra("rcode");
        if (!TextUtils.isEmpty(rcode)) {
            editCode.setText(rcode);
        }
    ...
    public void btnRegSubmitClick(View v) {
        ...
        SendData(username, password, password_confirm, email, code);
    }

    /**
     * 注册用户
     */
    public void SendData(String username, String password, String password_confirm, String email, String code) {
