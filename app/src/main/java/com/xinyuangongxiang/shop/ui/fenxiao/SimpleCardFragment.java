...
import com.xinyuangongxiang.shop.adapter.SimpleCardAdapter;
...
import com.xinyuangongxiang.shop.common.SwpipeListViewOnScrollListener;
...
public class SimpleCardFragment extends Fragment {
    ...
    public int firstVisible=0,visibleCount=0, lastVisibleItem=0;
...
//        OkHttpUtil.getAsyn(getActivity(), url, new OkHttpUtil.ResultCallback<String>() {
//            @Override
...
//                    if(data.isHasMore()){
//                        myListView.setPullLoadEnable(data.isHasMore());
//                        if(1 == page) {
//                            NewsListBean bean = new NewsListBean();
//                            bean.setIsfooder(true);
//                            newsList.add(bean);
//                        }
//                    }
